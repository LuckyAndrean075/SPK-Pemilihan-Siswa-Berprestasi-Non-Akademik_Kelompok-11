...
<body>
<header>
	<h1>Sistem Pendukung Keputusan Pemilihan Siswa Berprestasi Non Akademik <img src="image/unesa.png" style="width:74px;height:80px;" align="right"><img src="image/logo.png" style="width:80px;height:80px;" align="left"></h1>
	<h1>SMA Muhammadiyah 6 Paciran Lamongan</h1>
		...
		<ul>
			...
			<li>
				<a class="item" href="kriteria.php">Kriteria
					<!-- <div class="ui darkblue tiny label" style="float: right;"><?php echo getJumlahKriteria(); ?></div> -->
				</a>
			</li>
			<li>
				<a class="item" href="alternatif.php">Alternatif
					<!-- <div class="ui darkblue tiny label" style="float: right;"><?php echo getJumlahAlternatif(); ?></div> -->
				</a>
			</li>
